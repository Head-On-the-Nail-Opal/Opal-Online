...
public class Thermor : OpalScript
{
    override public void setOpal(string pl)
    {
        ...
        Attacks[1] = new Attack("Thermal Goo", 2, 4, 0, "Burn a target. Increase burn damage for each Armor you have.");
        Attacks[2] = new Attack("Hot Iron", 2, 4, 2, "Gain +4 attack before dealing damage. Thermor is hit by this attack as well.");
        Attacks[3] = new Attack("Cooling", 0, 1, 0, "Gain +2 defense and lose -2 attack. Take damage based on your attack stat.");
        type1 = "Metal";
        type2 = "Fire";
    }
